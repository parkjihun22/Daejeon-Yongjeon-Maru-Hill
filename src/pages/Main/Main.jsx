...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `새로운 주거 가치`,
    text2: `용전동 일대 변화와 함께 기대되는 미래가치<br/>
            새로운 주거 프리미엄 제안`,
        ...
        <>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 대전복합터미널 중심 생활권으로 편리한 교통 환경<br />
                  - 다양한 상업시설과 생활 인프라를 가까이 누리는 도심 입지<br />
                  - 용전동 일대 주거환경 변화와 함께 기대되는 미래 가치<br />
                  - 교통·생활·인프라를 모두 갖춘 새로운 주거 프리미엄
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="대전 용전 마루힐브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>대전 용전 마루힐</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mwvwdvqq"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="대전 용전 마루힐오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="대전 용전 마루힐mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              복합터미널 중심 생활권의 새로운 시작, 기대되는 미래가치<br/>
              대전 도심이 주목하는 새로운 주거 선택
              <br />
              <span className={styles.greyText1}>새로운 주거 프리미엄</span>
              <br />
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 대전 용전 마루힐에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="대전 용전 마루힐모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="대전 용전 마루힐브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="대전 용전 마루힐오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
