...
<Helmet>
  ...
  <meta property="og:title" content="대전 용전 마루힐 - 동·호수 배치" />
  <meta
...
<p className={styles.screenReaderOnly}>
  본 페이지는 대전 용전 마루힐의 동·호수 배치 정보를 제공합니다.
  동별 구성과 호수 배치를 확인하고 원하는 위치를 보다 쉽게 비교해보세요.
</p>

<div className={styles.textBox}>
  <div>새로운 주거 프리미엄의 시작</div>
  <div>대전 용전 마루힐이 선보이는 배치 가치를 확인하세요.</div>
</div>
