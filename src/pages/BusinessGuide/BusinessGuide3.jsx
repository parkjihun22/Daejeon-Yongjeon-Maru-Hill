...
<Helmet>
{/* 필수 메타 */}
<title>대전 용전 마루힐 - 계약서류안내</title>
<meta
  name="description"
  content="대전 용전 마루힐 계약을 위한 서류 안내. 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 빠르게 확인하세요."
/>
...
<meta property="og:title" content="대전 용전 마루힐 - 계약서류안내" />
<meta
  property="og:description"
  content="대전 용전 마루힐 계약서류 안내: 신분증·주민등록등본·인감증명서 등 필수 서류와 준비 절차, 유의사항을 확인하세요."
/>
<meta property="og:url" content="https://www.theporest.co.kr/BusinessGuide/documents" />
...
<h1 className={styles.screenReaderOnly}>대전 용전 마루힐 - 계약서류안내</h1>
<p className={styles.screenReaderOnly}>
본 페이지는 계약 체결을 위해 필요한 서류를 안내합니다.
제출 서류 목록과 준비 방법, 제출 기한 및 유의사항을 확인해 정확하고 빠르게 진행하세요.
</p>

<div className={styles.textBox}>
<div>새로운 주거 프리미엄의 시작</div>
<div>대전 용전 마루힐, 계약서류를 미리 준비하세요.</div>
</div>


			{/* 이미지에 isImageVisible 상태 적용 */}
			{/* <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="대전 용전 마루힐계약서류안내-image1" /> */}
